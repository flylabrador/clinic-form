                            ...
                            <div v-if="user[symptom.key] === 'yes'">
                              ...
                              <template v-if="symptom.key === 'chestTightnessPain'">
                                <v-text-field
                                  ...
                                  clearable
                                />
                                <v-label class="mb-2 d-inline-block mt-2">昏倒情形</v-label>
                                <v-radio-group
                    ...
                    <v-expansion-panel elevation="1">
                      ...
                      <v-expansion-panel-text>
                        ...
                        <v-autocomplete
                          ...
                          chips multiple variant="outlined"
                        />
                        <div v-if="user.FamilyHistory?.length" class="mt-2">
                          <v-row
                            v-for="fh in user.FamilyHistory"
                            :key="fh"
                            class="mb-1"
                          >
                            <v-col cols="12">
                              <v-text-field
                                v-model="user.familyHistoryNotes[fh]"
                                :label="`${fh}（補充說明）`"
                                variant="outlined"
                                clearable
                                :rules="fh === '惡性腫瘤'
                                  ? [familyNoteRequiredIfSelected('惡性腫瘤')]
                                  : []"
                              />
                            </v-col>
                          </v-row>
...
const user = ref<any>({
  ...
  chestTightnessPainSyncope: 'none',
  hypertensionRecentSys: null,
  hypertensionRecentDia: null,
  hypertensionMedicationAdherence: null,
